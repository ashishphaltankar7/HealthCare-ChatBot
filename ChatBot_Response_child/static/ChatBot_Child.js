class Chatbox {
    constructor() {
        this.args = {
            ...
            chatBox: document.querySelector('.sup'),
    ...
    onSendButton(chatbox) {
        ...
        // request.open('POST','/predict/${JSON.stringify(text1)}')
        // request.onload=()=>{
        ...
        // $SCRIPT_ROOT+'/predict1'

        fetch($SCRIPT_ROOT+'/predict1', {
            method: 'POST',
